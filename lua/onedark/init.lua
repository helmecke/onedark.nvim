...
h('SpellBad', { fg = red, gui = 'undercurl', cterm = 'undercurl' })
h('SpellCap', { fg = dark_yellow })
h('SpellLocal', { fg = dark_yellow })
h('SpellRare', { fg = dark_yellow })
h('StatusLine', { fg = white, bg = vertsplit })
h('StatusLineNC', { fg = comment_grey, bg = vertsplit })
h('StatusLineTerm', { fg = white, bg = vertsplit })
h('StatusLineTermNC', { fg = comment_grey, bg = vertsplit })
...
h('NvimTreeNormal', { bg = vertsplit })
h('NvimTreeNormalNC', { bg = vertsplit })
h('NvimTreeSymlink', { fg = white })
h('NvimTreeFolderName', { fg = white })
h('NvimTreeRootFolder', { fg = white })
h('NvimTreeFolderIcon', { fg = white })
h('NvimTreeEmptyFolderName', { fg = white })
h('NvimTreeOpenedFolderName', { fg = white })
h('NvimTreeIndentMarker', { fg = white })
h('NvimTreeGitDirty', { fg = yellow })
h('NvimTreeGitNew', { fg = green })
h('NvimTreeGitDeleted', { fg = red })
h('NvimTreeIndentMarker', { fg = gutter_fg_grey })
h('NvimTreeSymlink', { fg = white })
h('NvimTreeFolderName', { fg = white })
h('NvimTreeRootFolder', { fg = white })
h('NvimTreeFolderIcon', { fg = white })
...
-- WhichKey colors
h('WhichKey', { fg = blue })
h('WhichKeyGroup', { fg = green })
h('WhichKeySeparator', { fg = comment_grey })
h('WhichKeyDesc', { fg = white })
h('WhichKeyFloat', { bg = cursor_grey })
h('WhichKeyValue', { fg = red })

-- Cmp colors
h('CmpItemAbbr', { fg = white })
h('CmpItemAbbrDeprecated', { fg = red })
h('CmpItemAbbrMatch', { fg = blue })
h('CmpItemAbbrMatchFuzzy', { fg = blue })
