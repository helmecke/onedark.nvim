...
---@return nil
function M.cache()
  local cache = require("onedark.lib.cache")
  local themes = require("onedark.theme").themes
  local compiler = require("onedark.lib.compile")
...
function M.reset()
  ...
  require("onedark.config").reset()
  require("onedark.override").reset()
end
...
function M.load()
  ...
  if vim.fn.has("nvim-0.9") == 0 then
    return require("onedark.utils.deprecate").write(
